...
- Active test blocks: 3456
- Ignored/manual test blocks: 139
- Declared test blocks: 3595
- Weighted coverage points: 2848.1
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| windows | 29 | 3313 | 133 | 2783.0 | 21 | 11 | 100% |
| macos | 29 | 3375 | 114 | 2797.0 | 22 | 11 | 100% |
| linux | 25 | 2943 | 106 | 2442.3 | 20 | 11 | 100% |

## Crate Summary

| Crate | Suites | Integration files | Source unit files | Active tests | Ignored tests | Weighted points | Flows |
| --- | --- | --- | --- | --- | --- | --- | --- |
| screenpipe-engine | 10 | 19 | 116 | 1700 | 42 | 1310.8 | 10 |
| screenpipe-db | 5 | 55 | 20 | 507 | 16 | 480.3 | 9 |
...
| database | 6 suites / 454 active / 12 ignored / 427.3 pts | 6 suites / 454 active / 12 ignored / 427.3 pts | 6 suites / 454 active / 12 ignored / 427.3 pts |
...
| engine-lifecycle | 6 suites / 243 active / 1 ignored / 218.0 pts | 6 suites / 243 active / 1 ignored / 218.0 pts | 5 suites / 237 active / 1 ignored / 216.3 pts |
| local-api | 2 suites / 415 active / 9 ignored / 292.9 pts | 2 suites / 415 active / 9 ignored / 292.9 pts | 2 suites / 415 active / 9 ignored / 292.9 pts |
| meeting | 6 suites / 1612 active / 20 ignored / 1315.6 pts | 6 suites / 1612 active / 20 ignored / 1315.6 pts | 4 suites / 1275 active / 16 ignored / 1001.1 pts |
...
| performance | 13 suites / 1509 active / 67 ignored / 1329.5 pts | 14 suites / 1616 active / 71 ignored / 1372.3 pts | 13 suites / 1509 active / 67 ignored / 1329.5 pts |
| pipes | 1 suites / 506 active / 3 ignored / 354.2 pts | 1 suites / 506 active / 3 ignored / 354.2 pts | 1 suites / 506 active / 3 ignored / 354.2 pts |
| privacy | 5 suites / 937 active / 36 ignored / 760.3 pts | 5 suites / 995 active / 17 ignored / 768.8 pts | 5 suites / 915 active / 14 ignored / 739.2 pts |
...
| storage | 3 suites / 559 active / 29 ignored / 457.0 pts | 3 suites / 559 active / 29 ignored / 457.0 pts | 3 suites / 559 active / 29 ignored / 457.0 pts |
| sync | 1 suites / 506 active / 3 ignored / 354.2 pts | 1 suites / 506 active / 3 ignored / 354.2 pts | 1 suites / 506 active / 3 ignored / 354.2 pts |
| timeline | 4 suites / 1118 active / 33 ignored / 905.6 pts | 4 suites / 1118 active / 33 ignored / 905.6 pts | 4 suites / 1118 active / 33 ignored / 905.6 pts |
| transcription | 5 suites / 800 active / 41 ignored / 625.9 pts | 5 suites / 800 active / 41 ignored / 625.9 pts | 5 suites / 800 active / 41 ignored / 625.9 pts |
| ui-events | 4 suites / 753 active / 28 ignored / 572.7 pts | 3 suites / 704 active / 5 ignored / 538.4 pts | 3 suites / 704 active / 5 ignored / 538.4 pts |
...
| Performance, backpressure, and liveness | performance | covered (strong; db-timeline-frames, engine-capture-timeline) | covered (strong; db-timeline-frames, engine-capture-timeline) | covered (strong; db-timeline-frames, engine-capture-timeline) |
...
| db-timeline-frames | screenpipe-db | windows, macos, linux | database, timeline, storage, performance | timeline-streaming, performance-liveness | high | strong | mixed | 25 | 219 | 3 | Frame/audio joins, timeline query shape, suggestions frames, write queue, DB primitives (src/db.rs split into src/db/ modules), feedback record upserts, media eviction anti-join regressions, SAF output registry, semantic storage, and timeline performance. |
| engine-api-routes | screenpipe-engine | windows, macos, linux | local-api, timeline, meeting, transcription | local-api-search, timeline-streaming, meeting-live-notes, audio-record-transcribe | high | partial | mixed | 40 | 407 | 4 | Route/unit coverage for search, health, streaming, meetings, time/timezone, and transcription. Legacy endpoint/websocket tests require local data and remain ignored. |
...
| engine-db-recovery-cli | screenpipe-engine | windows, macos, linux | database, engine-lifecycle | engine-health-lifecycle, performance-liveness | high | strong | unit | 1 | 25 | 0 | Exact DB/WAL/SHM working-copy preservation, rollback on archive failure, and restart repair for crashes during the multi-file generation swap. |
...
| engine-meeting-privacy-sync | screenpipe-engine | windows, macos, linux | meeting, privacy, ui-events, pipes, sync | meeting-live-notes, privacy-and-redaction, accessibility-ui-events, performance-liveness | medium | strong | unit | 32 | 506 | 3 | Unit-heavy coverage for privacy filter policy, capture exclusions, UI recorder safety, pipes/live-view/structured-output helpers, sync helpers, and CLI parsing. Meeting detection moved to the engine-meeting-watcher suite. |
...
| db-timeline-frames | screenpipe-db | src/db/maintenance.rs | source | 7 | 1 | 8 |
...
| db-timeline-frames | screenpipe-db | src/storage/bulk/tests.rs | source | 5 | 0 | 5 |
...
| db-timeline-frames | screenpipe-db | src/write_queue.rs | source | 37 | 0 | 37 |
...
| db-runtime-reliability | screenpipe-db | tests/close_severs_connections_test.rs | integration | 3 | 0 | 3 |
...
| db-timeline-frames | screenpipe-db | tests/hybrid_storage.rs | integration | 15 | 0 | 15 |
...
| db-runtime-reliability | screenpipe-db | tests/quarantine_self_heal_test.rs | integration | 8 | 0 | 8 |
...
| engine-meeting-privacy-sync | screenpipe-engine | src/cli/agent.rs | source | 34 | 0 | 34 |
| engine-db-recovery-cli | screenpipe-engine | src/cli/db.rs | source | 25 | 0 | 25 |
...
| engine-api-routes | screenpipe-engine | src/routes/streaming.rs | source | 22 | 0 | 22 |
